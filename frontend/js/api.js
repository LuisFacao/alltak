// Usa a mesma origem (host:porta) de onde a página foi carregada.
// Assim o front e o back rodam juntos, no mesmo processo/porta, sem CORS
// e sem depender de nenhum serviço externo (Render, Supabase, etc).
